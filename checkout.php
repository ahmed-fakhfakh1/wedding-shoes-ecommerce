            ...
            <div class="card shadow-lg" style="border: none; border-radius: 10px;">
                <div class="card-body">
                    ...
                    <?php if ($prod['image_url']): ?>
                        <img src="<?php echo $prod['image_url']; ?>" class="img-fluid mb-3" alt="<?php echo $prod['name']; ?>" style="border-radius: 8px; max-height: 300px; object-fit: cover;">
                    <?php endif; ?>
                    <!-- Product Details -->
                    <div class="mb-3">
                        <h6 class="fw-bold mb-2"><?php echo $prod['name']; ?></h6>
                        <p class="text-muted small mb-1">
                            <strong>Category:</strong> <?php echo $category_names[$prod['category_id']] ?? 'Unknown'; ?>
                        </p>
                        <p class="text-muted small mb-1">
                            <strong>SKU:</strong> <?php echo $prod['sku']; ?>
                        </p>
                        <p class="text-muted small mb-1">
                            <strong>Available Sizes:</strong> <?php echo $prod['size']; ?>
                        </p>
                    </div>
                    <hr>
                    <!-- Price Breakdown -->
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="address" name="address" rows="3" 
                                           style="background-color: #f5f5f5;"><?php echo $user_address; ?></textarea>
                            </div>
                        </div>
                        <hr>
