...
// Get all products and filter for Women only
$product = new Product();
...
<!-- Page Header -->
<section style="background: linear-gradient(135deg, rgba(196, 30, 58, 0.8), rgba(27, 27, 27, 0.8)), url('images/womanbanner.jpg'); background-size: cover; background-position: center; color: white; padding: 100px 0; text-align: center;">
    <div class="container">
        <h1 class="display-4 fw-bold mb-2">Women's Shoes</h1>
        <p class="lead">Stylish shoes for every occasion</p>
    </div>
</section>
...
<div class="container mt-5 mb-5">
    ...
    <div class="mb-5">
        ...
        <div class="filter-buttons d-flex flex-wrap gap-2">
            ...
            <?php 
            // Get unique categories for women's shoes
            $unique_categories = [];
